...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    const doSearch = (x: string) => {
        ...
        var query = new SearchQuery(x, "Eligendi totam ipsam quo a eligendi quisquam at. In voluptatum incidunt saepe. Mollitia aspernatur eos aliquam consectetur molestiae. Dolores cupiditate neque a." +
